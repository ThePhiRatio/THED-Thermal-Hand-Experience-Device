...
{
    /// <summary>
    /// Class responsible for converting the Values read and stored on <see cref="CalibrationValues"/> into an absolute position.  The GameObject containing this script must have a <see cref="CalibrationValues"/> and a <see cref="PositionInterpreter"/>
    /// </summary>
    [Serializable]
    public class AbsolutePositionConverter : MonoBehaviour, IConverter
    {
