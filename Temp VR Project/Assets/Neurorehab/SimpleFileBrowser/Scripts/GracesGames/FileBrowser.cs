...
namespace Neurorehab.SimpleFileBrowser.Scripts.GracesGames
{
    ...
    public class FileBrowser : MonoBehaviour
    {
        ...
        private string CurrentPath
        {
            ...
            get
            {
                if (_currentPath == "")
                {
                    _currentPath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\RehaPanel";
        ...
        private ScrollRect _directoriesScrollRect;
        private ScrollRect _filesScrollRect;
        /// <summary>
        /// indicates if DestroyImmidiatly has been invoked on this gameobject
        /// </summary>
        ...
        private void Awake()
        {
            ...
            _directoriesScrollRect = _directoriesParent.transform.parent.GetComponent<ScrollRect>();
            _filesScrollRect = _filesParent.transform.parent.GetComponent<ScrollRect>();
        }
        ...
        private void SetupFileBrowser()
        {
            ...
            GameObject uiCanvas = GameObject.Find("SaveAndLoadCanvas");
            if (uiCanvas == null)
            {
        ...
        public void SelectFile()
        {
            ...
            if (_mode == FileBrowserMode.Save)
            {
                ...
                {
                    var extension = inputFieldValue.Split('.').Last();
                    if (extension != _fileExtension)
                        inputFieldValue += "." + _fileExtension;
        ...
        private void UpdateFileBrowser(bool topLevel = false)
        {
            ...
            BuildFiles();
            GuiUtilities.Instance.CanvasUpdate(_directoriesScrollRect, 1);
            GuiUtilities.Instance.CanvasUpdate(_filesScrollRect, 1);
        }
        ...
        private void UpdatePathText()
        {
            ...
            {
                _pathText.GetComponent<Text>().text = CurrentPath;
            }
        }
        ...
        private void BuildDirectories(bool topLevel)
        {
            ...
            {
                MessageManager.Instance.ShowErrorMessage("You have no rights to access that directory. Try running the application with administrator rights");
                DirectoryUp();
            }
        }
    ...
    // Returns whether the application is run on a Windows Operating System
        ...
        private void CreateFileButton(string file)
        {
            ...
            button.AddComponent<SaveLoadFileDoubleClick>();
        ...
        {
            _destroyed = true;
            DestroyImmediate(GameObject.Find("FileBrowserUI"));
            DestroyImmediate(GameObject.Find("FileBrowser"));
        }
